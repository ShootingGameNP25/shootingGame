...
public class ReadyPanel extends JPanel{
    ...
    public ReadyPanel(GameFrame gameFrame, ChatPanel chatPanel, PlayerPanel playerPanel) {
        ...
        delRoomBtn.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
        		...
        		delLog = new DelDialog(gameFrame, ReadyPanel.this.client, roomName, "방 삭제");
    ...
    public void updateRoomList(String roomName, String explain, String count) {
    	roomTable.addRow(new Object[] { roomName, explain, count });
    }
    ...
    class DelDialog extends JDialog{
    	...
    	public DelDialog(JFrame frame, GameClient client, String roomName, String title) {
    		...
    		okBtn.addActionListener(new ActionListener() {
    			...
    			public void actionPerformed(ActionEvent e) {
    				...
    				if(password.isEmpty()) {
    					JOptionPane.showMessageDialog(DelDialog.this, "비밀번호를 입력하세요");
    					return;
    				}
    				
    				client.deleteRoom(roomName, password);
    				dispose();
    			}
    		});
